...
int main() {
  ...
  hls::stream<network_word> input_1("input_1");
  hls::stream<network_word> input_2("input_2");
  hls::stream<network_word> input_3("input_3");
  hls::stream<network_word> output_1("output_1");
  hls::stream<network_word> output_2("output_2");
  hls::stream<network_word> output_3("output_3");
  ...
  network(len_bytes, input_1, output_1, input_2, output_2, input_3, output_3);
